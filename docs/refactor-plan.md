...
- Inventory + contracts: `docs/phase-0-inventory.md`.
- External dashboard reconnaissance: `docs/hemo-integration-notes.md`.
- Telemetry guidance: `docs/telemetry-guidance.md`.
...
- Core boundary contract + test tooling: `docs/phase-1-core-boundary.md`.
...
### Phase 2 Output (In Progress)
- Adapter layer kickoff: `docs/phase-2-adapter-layer.md`.
...
### Tooling Setup (Environment Ready)
