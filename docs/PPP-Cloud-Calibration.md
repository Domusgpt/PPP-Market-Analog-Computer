...
The summary manifest stores SHA-256 hashes for all artifacts so they can be validated after upload.
...
3. **Validate**: verify manifest hashes and enforce acceptance checks.
