...
export class WebEngine {
     ...
     */
    frame_count() {
        const ret = wasm.webengine_frame_count(this.__wbg_ptr);
    ...
    get_analysis() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.webengine_get_analysis(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get_patterns() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.webengine_get_patterns(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    get_vertices() {
        const ret = wasm.webengine_get_vertices(this.__wbg_ptr);
     ...
     * @returns {WebEngine}
     */
    static new_expanded(canvas_id) {
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webengine_new_expanded(ptr0, len0);
        if (ret[2]) {
    ...
    inject_channel(channel, value) {
        wasm.webengine_inject_channel(this.__wbg_ptr, channel, value);
    }
    /**
     ...
     */
    get_view_matrix() {
        const ret = wasm.webengine_get_view_matrix(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
    ...
    inject_channels(values) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.webengine_inject_channels(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    get_betti_numbers() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.webengine_get_betti_numbers(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_trinity_state() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.webengine_get_trinity_state(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set_rotation_speeds(xy, xz, xw, yz, yw, zw) {
        wasm.webengine_set_rotation_speeds(this.__wbg_ptr, xy, xz, xw, yz, yw, zw);
    }
    /**
    ...
    get_projection_matrix() {
        const ret = wasm.webengine_get_projection_matrix(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
    ...
    is_synthesis_detected() {
        const ret = wasm.webengine_is_synthesis_detected(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    get_dialectic_distance() {
        const ret = wasm.webengine_get_dialectic_distance(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    update(delta_time) {
        wasm.webengine_update(this.__wbg_ptr, delta_time);
    }
    /**
    ...
    get_mode() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.webengine_get_mode(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set_mode(mode) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.webengine_set_mode(this.__wbg_ptr, ptr0, len0);
    }
    /**
     ...
     */
    get_edges() {
        const ret = wasm.webengine_get_edges(this.__wbg_ptr);
...
export function get_description() {
    ...
    let deferred1_1;
    try {
        const ret = wasm.get_description();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('geometric_cognition_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
