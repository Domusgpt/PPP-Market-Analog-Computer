...
## Session 39 – Adapter registry utility
- Added AdapterRegistry for managing multiple adapters in integrations.
- Added registry usage snippet and registry tests.

## Session 40 – Registry lifecycle helpers
- Added unregister and forEach helpers to AdapterRegistry for lifecycle management.
- Extended registry tests and usage docs to cover registry iteration and removal.

## Session 41 – Adapter sample script
- Added a runnable MarketQuote adapter sample under `samples/` for end-to-end ingestion verification.
- Linked the sample script from the adapter usage guide.
- Validated the sample with `npx tsx samples/adapter-market-quote.ts`.
