...
This repo is a static site, so GitHub Pages can serve it directly.

1. Push the repo to GitHub.
2. Go to **Settings → Pages**.
3. Under **Build and deployment**, choose **Deploy from a branch**.
4. Select the branch you want (for example, `main`) and set the folder to `/ (root)`.
5. Save. GitHub will publish the site and show the public URL.

Optional: create a `docs/` folder and move `index.html` + `scripts/` + `assets/` there if you prefer the Pages source to be `/docs`.
