...
The `anchorBatch` callback may return a string hash or an object of the form `{ hash, anchoredAt }` to override the anchoring timestamp. Use `onBatchAnchorError` to respond to persistence failures.
